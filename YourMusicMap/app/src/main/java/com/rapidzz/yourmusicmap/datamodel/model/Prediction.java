...
public class Prediction {
    ...
    public Prediction(String description, String id, List<MatchedSubstring> matchedSubstrings, String placeId, String reference, StructuredFormatting structuredFormatting, List<Term> terms, List<String> types) {
