...
/**
 * Created by Yasir_Ali on 12/5/2018.
 */
public class PlacesAutoCompleteAdapter
    ...
    /**
     * The bounds used for Places Geo User autocomplete API requests.
     */
     ...
     */
    public PlacesAutoCompleteAdapter(Context context, int resource, GoogleApiClient googleApiClient, AutocompleteFilter filter) {
   ...
   /* @Override
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            ...
            while (iterator.hasNext()) {
                ...
                // Get the details of this prediction and copy it into a new PlaceSearch object.
    ...
    /**
     * Holder for Places Geo User Autocomplete API results.
     */
