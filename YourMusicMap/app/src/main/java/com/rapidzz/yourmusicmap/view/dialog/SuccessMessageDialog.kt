...
class SuccessMessageDialog : androidx.fragment.app.DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(message: String, call: String): SuccessMessageDialog{
            var dialogAlert = SuccessMessageDialog()
            var bundle = Bundle()
